...
def check():
    ...
    # Is it good?
    #in_jumble and matched will be set to either True or False
    in_jumble = LetterBag(jumble).contains(text)
    matched = WORDS.has(text)

    rslt = {"inWords": matched, "inJumble": in_jumble, "foundAll": False,
                "previouslyFound": text in matches, "jumbleLetters": jumble,
                "userText": text, "prevMatches": matches}
    ...
    if len(matches) >= flask.session["target_count"]:
       rslt = {"inWords": matched, "inJumble": in_jumble, "foundAll": True,
                   "previouslyFound": text in matches, "jumbleLetters": jumble,
                   "userText": text, "prevMatches": matches}
...
def example():
    ...
    #rslt = {"inWords": text in wordList, "userText": text}
    return flask.jsonify(result=rslt)
